      ...
      <div className="p-3">
        ...
        <div className='rounded-3xl  border-gray overflow-hidden bg-white inset-shadow-xl hover:shadow-md transition w-64 mt-4'>
          <div className='relative'>
            <img src={barcaImage} alt="Product" className="w-full h-48 object-cover mb-4" />
  
            <span className="absolute top-2  bg-gray bg-opacity-60 text-black text-xs px-2 py-1 rounded">Guest favorite</span>
          </div>
          <div className='p-4'>
